...
Adding squared terms to the model (make the model more flexible) seems to lower the biases (the true value seems to be non-linear and have higher power (such as squared) relations)m but this could increase the variance of the model and make the model more likely to overfit. But in general, this more flexible model seems to have a good balance of bias-variance and the variance may not increase a lot as compared to the lowering in biases.
